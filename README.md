...
The repo ships three demo gamedirs under [`examples/`](https://github.com/FullCircleMUD/evennia-shards/tree/main/examples) — `demo_router`, `demo_shard0`, `demo_shard1` — that exercise the library end-to-end on a single machine.

Each demo gamedir runs as its own Evennia process with its own `settings.py` declaring its `SHARDS_ROLE` and `SHARD_ID`. See [`examples/README.md`](https://github.com/FullCircleMUD/evennia-shards/blob/main/examples/README.md) for the run-three-processes recipe.

## Documentation

All technical documentation lives in [docs/](https://github.com/FullCircleMUD/evennia-shards/tree/main/docs). Start at [docs/INDEX.md](https://github.com/FullCircleMUD/evennia-shards/blob/main/docs/INDEX.md) for the doc map and reading paths.

Notable entry points:

- **[docs/INDEX.md](https://github.com/FullCircleMUD/evennia-shards/blob/main/docs/INDEX.md)** — map of all design documents.
- **[docs/progress.md](https://github.com/FullCircleMUD/evennia-shards/blob/main/docs/progress.md)** — running log of milestones with links to evidence (test results, design docs, code changes).
- **[docs/archive/evennia-shards-HANDOVER.md](https://github.com/FullCircleMUD/evennia-shards/blob/main/docs/archive/evennia-shards-HANDOVER.md)** — the original brainstorm session that started this project. Archived as historical context; current decisions extend and refine it.
- **[CLAUDE.md](https://github.com/FullCircleMUD/evennia-shards/blob/main/CLAUDE.md)** — instructions for LLM agents working in this repo.

## Project relationships

This library was extracted from scaling work originally done for the [FullCircleMUD (FCM)](https://fcmud.world) project. FCM is its first consumer game and depends on the library today. The library is deliberately game-agnostic; FCM-specific concerns stay in FCM. See [the origin section of the archived handover](https://github.com/FullCircleMUD/evennia-shards/blob/main/docs/archive/evennia-shards-HANDOVER.md#origin-why-this-is-a-separate-project) for the original rationale.

## License

BSD 3-Clause — see [LICENSE](https://github.com/FullCircleMUD/evennia-shards/blob/main/LICENSE). Same family as Evennia's license.
